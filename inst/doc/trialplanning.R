...
## ----echo = FALSE, warning = FALSE, fig.cap = " Figure 1 - Multistate model with indermediate state progession and absorbing state death", fig.height = 5, fig.width = 8, out.width = "60%"----
library(prodlim)
